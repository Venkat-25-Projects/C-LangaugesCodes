...
void sort(char array[], int size)
{
    ...
    for(i = 0; i < size - 1; i++)  // Outer loop for number of passes
    {
        for(j = 0; j < size - 1 - i; j++)  // Inner loop for comparing adjacent elements
        {
...
void printArray(char array[], int size)
{
    ...
    for(i = 0; i < size; i++)  // Loop to print each character in the array
    {
        printf("%c ", array[i]);
    }
    printf("\n");
